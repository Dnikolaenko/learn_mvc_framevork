...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div id="wrapper">
			<div id="header">
				<div id="logo">
					<a href="/">Фарма</span> <span class="cms">Кология</span></a>
				</div>
				<div id="menu">
					<ul>
						<li class="first active"><a href="/">Главная</a></li>
						<li><a href="/services">Пептиды</a></li>
						<li><a href="/portfolio">Фарма</a></li>
						<li><a href="/portfolio">Метан</a></li>
